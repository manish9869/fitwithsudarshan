        ...
        try {
            const [coachRes, customerRes] = await Promise.all([
                fetch(`${API_BASE}/api/send-email`, {
                    ...
                    body: JSON.stringify({
                        template: "contact_inquiry_coach",
                        to: contact.email,
                        data: payload,
                    }),
                }),
                ...
                fetch(`${API_BASE}/api/send-email`, {
                    ...
                    body: JSON.stringify({
                        template: "contact_inquiry_customer",
                        to: form.email.trim(),
                        data: payload,
                    }),
                }),
            ...
            >
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
                        Ready to start your RECODE journey? Reach out — Sudarshan
                        personally responds to all inquiries.
                    </p>
                </motion.div>
                            ...
                            {status === "success" && (
                                ...
                                >
                                    ...
                                    <p className="text-muted-foreground text-sm leading-relaxed">
                                        Sudarshan will get back to you within
                                        24 hours.
                                        <br />
                            ...
                            {status === "error" && (
                                ...
                                >
                                    ...
                                    <span>
                                        ...
                                        WhatsApp instead or retry in a moment.
                                    </span>
                                </motion.div>
                            )}
