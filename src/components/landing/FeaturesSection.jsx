                ...
                {Array.from({ length: 6 }).map((_, i) => (
                    <motion.div
                        ...
                        style={{
                            left: `${(i + 1) * 14.28}%`,
                            background:
                                'linear-gradient(to bottom, transparent 0%, rgba(231,23,99,0.08) 40%, rgba(231,23,99,0.12) 50%, rgba(231,23,99,0.08) 60%, transparent 100%)'
                        }}
...
function MagneticCard({ children, className, style }) {
    ...
    const handleMove = (e) => {
        ...
        el.style.transform =
            `perspective(800px) rotateY(${x / 22}deg) rotateX(${-y / 22}deg) translateZ(8px)`;
...
export default function FeaturesSection() {
    ...
    const coachInView = useInView(coachRef, {
        once: true,
        margin: "-60px"
    });

    const recodeInView = useInView(recodeRef, {
        once: true,
        margin: "-60px"
    });
    ...
    // Site data is loaded asynchronously by SiteDataProvider.
    // Don't render this section until the required objects are available.
    if (!coach || !whyRecode) {
        return null;
    }
            ...
            <SectionAtmosphere>
                ...
                >
                    <div className="container mx-auto px-4 max-w-6xl">
                        ...
                        >
                            <motion.span
                                className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.25em] px-4 py-2 rounded-full"
                                style={{
                                    color: '#e71763',
                        ...
                        <div className="grid lg:grid-cols-[420px_1fr] gap-10 sm:gap-14 items-start">
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background:
                                            'radial-gradient(ellipse at 40% 50%, rgba(231,23,99,0.22) 0%, transparent 70%)'
                                    }}
                                />
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                'linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.15) 45%, transparent 70%)'
                                        }}
                                    />
                            ...
                            >
                                <div>
                                    ...
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <span className="text-xs text-white/30 font-semibold tracking-widest uppercase">
                                            ACSM Certified · 8+ Years
                                        </span>
                                    </div>

                                    <p className="text-white/65 leading-relaxed text-base mb-3">
                                        {coach.shortBio}
                                    </p>
                                ...
                                <div className="space-y-2.5">
                                    {[
                                        ...
                                        <motion.div
                                            ...
                                            style={{
                                                background:
                                                    'rgba(231,23,99,0.035)',
                                                border:
                                                    '1px solid rgba(231,23,99,0.1)',
            ...
            <SectionAtmosphere>
                <div className="absolute inset-0 pointer-events-none">
                    <motion.div
                        ...
                        style={{
                            background:
                                'radial-gradient(ellipse 80% 50% at 50% 50%, rgba(231,23,99,0.07) 0%, transparent 70%)'
                        }}
                        animate={{
                            opacity: [0.5, 1, 0.5]
                        }}
                ...
                >
                    <div className="container mx-auto px-4 max-w-6xl">
                        <div className="grid lg:grid-cols-2 gap-12 sm:gap-20 items-start">
                            ...
                            >
                                <motion.span
                                    className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.25em] px-4 py-2 rounded-full mb-8"
                                    style={{
                                        color: '#e71763',
                                        border:
                                            '1px solid rgba(231,23,99,0.28)',
                                        background:
                                            'rgba(231,23,99,0.07)'
                                    }}
                                    animate={{
                                    ...
                                    {[
                                        {
                                            letter: "R",
                                            word: "Recovery",
                                            desc: "Rest, sleep and stress regulation first"
                                        },
                                        {
                                            letter: "E",
                                            word: "Energy",
                                            desc: "Restore metabolic health and vitality"
                                        },
                                        {
                                            letter: "C",
                                            word: "Control",
                                            desc: "Build sustainable habits and discipline"
                                        },
                                        {
                                            letter: "O",
                                            word: "Optimisation",
                                            desc: "Dial in training, nutrition, performance"
                                        },
                                        {
                                            letter: "D",
                                            word: "Direction",
                                        ...
                                        },
                                        {
                                            letter: "E",
                                            word: "Evolution",
                                            desc: "Long-term growth beyond the program"
                                        },
                                    ].map((item, i) => (
                                        <motion.div
                                            key={i}
                                        ...
                                        >
                                            ...
                                            <span className="font-bold text-white/90 text-sm w-24">
                                                {item.word}
                                            </span>
                            ...
                            >
                                <motion.div
                                    className="absolute top-0 bottom-6 w-0.5 rounded-full"
                                    style={{
                                        background:
                                            'linear-gradient(to bottom, #e71763 0%, rgba(231,23,99,0.2) 100%)'
                                    }}
                                    initial={{
                                        scaleY: 0,
                                        originY: 0
                                    ...
                                    {recodeMethod.map((r, i) => (
                                        ...
                                        >
                                            <motion.div
                                                ...
                                                style={{
                                                    background:
                                                        'linear-gradient(135deg, rgba(231,23,99,0.3), rgba(231,23,99,0.08))',
                                                    border:
                                                        '1px solid rgba(231,23,99,0.5)'
                                                }}
                                            >
                                                <span
                                            ...
                                            >
                                                <h3
                                                    className={`text-sm font-black mb-1 tracking-wide ${r.accent ||
                                                        'text-primary'
                                                        }`}
                                                >
                                                    {r.title}
            ...
            <SectionAtmosphere>
                ...
                >
                    ...
                    <div className="container mx-auto px-4 max-w-5xl relative">
                        ...
                        <div className="space-y-4">
                            {[
                                ...(whyRecode.others || []).map(
                                    (other, i) => ({
                                        bad: other,
                                        good:
                                            (whyRecode.recode || [])[i] ||
                                            "Personalised recovery-first approach",
                                    })
                                ),

                                {
                                    bad: "One-size-fits-all templates",
                                    good: "Recovery-led transformation approach"
                                },

                                {
                                    bad: "Short-term calorie cutting",
                                    good: "Sustainable long-term lifestyle change"
                                },
                            ].map((row, i) => (
                                <motion.div
                                    key={i}
                                ...
                                >
                                    {/* Bad side */}
                                    <div
                                        className="p-3 sm:p-4 flex items-center gap-2 sm:gap-3 group"
                                        style={{
                                            background:
                                                'rgba(239,68,68,0.04)'
                                        }}
                                    >
                                        ...
                                        <span className="text-xs sm:text-sm text-white/30 line-through decoration-red-500/30 leading-snug">
                                            {row.bad}
                                        </span>
                                    </div>
                                    ...
                                    >
                                        ...
                                        <span className="text-xs sm:text-sm text-white/85 font-medium leading-snug">
                                            {row.good}
                                        </span>
                                    </div>
                                </motion.div>
                        ...
                        >
                            <div
                                className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 rounded-2xl"
                                style={{
                                    background:
                                        'rgba(231,23,99,0.08)',
                                    border:
                            ...
                            >
                                ...
                                <span className="text-xs sm:text-sm font-black text-white">
                                    RECODE™ — Recovery-based. Science-backed. Built for{' '}
                                    <span
                                        style={{
                                            color: '#e71763'
                                        }}
                    ...
                    {[0, 1].map((row) => (
                        ...
                        >
                            {Array.from({
                                ...
                                <span
                                    key={i}
                                    className="text-[80px] font-black tracking-widest"
                                    style={{
                                        color:
                                            'rgba(231,23,99,0.04)'
                                    }}
