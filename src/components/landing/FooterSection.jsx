...
export default function FooterSection() {
    // ── Site data from SiteDataContext ────────────────────────────────────
    const { contact, brand, footer } = useSiteData();
    ...
    const navSections = footer?.navSections?.length
        ? footer.navSections
        : [
            { name: "Home", href: "#home" },
    ...
    const programs = footer?.programs?.length
        ? footer.programs
        : [
    ...
    const resources = footer?.resources?.length
        ? footer.resources
        : [
    ...
    return (
        <footer
            ...
            style={{
                background:
                    "linear-gradient(to bottom, hsl(var(--background)), #000)",
            }}
        >
            {/* Scattered bg icons */}
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(90deg, transparent 0%, rgba(231,23,99,0.6) 30%, rgba(231,23,99,1) 50%, rgba(231,23,99,0.6) 70%, transparent 100%)",
                    }}
                />
            ...
            <div className="relative container mx-auto px-4 max-w-6xl">
                ...
                <motion.div
                    ...
                    style={{
                        background:
                            "linear-gradient(135deg, rgba(231,23,99,0.12) 0%, rgba(231,23,99,0.04) 50%, rgba(0,0,0,0.4) 100%)",
                ...
                >
                    <motion.div
                        ...
                        style={{
                            background:
                                "radial-gradient(ellipse at 20% 50%, rgba(231,23,99,0.12) 0%, transparent 60%)",
                        }}
                        animate={{
                            opacity: [0.5, 1, 0.5],
                        }}
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center relative">
                        <div>
                            ...
                            <h3 className="text-2xl md:text-3xl font-black text-white mb-2">
                                Get Free RECODE™ Insights
                            </h3>

                            <p className="text-white/45 text-sm leading-relaxed">
                                Weekly recovery, nutrition &amp; transformation
                                tips delivered to your inbox. No spam, ever.
                            </p>
                        </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-10 mb-14">
                    ...
                    {[
                        ...
                        >
                            <h4 className="text-xs font-black uppercase tracking-[0.2em] text-white/50 mb-5">
                                {title}
                            </h4>
                ...
                >
                    <div
                        ...
                        style={{
                            background:
                                "linear-gradient(90deg, transparent, rgba(231,23,99,0.6), transparent)",
                        }}
                    />

                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="text-xs text-white/25">
                            © {currentYear} FitWithSudarshan. All rights
                            reserved. Built with{" "}
                            <Heart
