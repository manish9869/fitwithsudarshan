    ...
    while (i < lines.length) {
        ...
        if (line.startsWith('## ')) {
            elements.push(
                <h2
                    key={i}
                    className="text-xl font-black mt-8 mb-4 text-white"
                >
                    {line.replace('## ', '')}
                </h2>
            );
        ...
        >
            ...
            <motion.div
                ...
                style={{
                    ...
                    boxShadow:
                        '0 0 0 1px rgba(231,23,99,0.08), 0 0 80px rgba(231,23,99,0.12), 0 40px 100px rgba(0,0,0,0.85)',
                }}
            ...
            >
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                style={{
                                    background:
                                        'linear-gradient(to top, rgba(10,10,10,1) 0%, rgba(10,10,10,0.35) 55%, rgba(10,10,10,0.05) 100%)'
                                }}
                            />

                            <span
                                className="absolute top-4 left-4 px-3 py-1 rounded-full text-[11px] font-black tracking-wide"
                                style={{
                                    background: cat.bg,
                                    color: cat.color,
                            ...
                            <div className="absolute bottom-4 left-5 right-16">
                                <h2 className="text-lg sm:text-2xl font-black text-white leading-tight mb-2">
                                    {post.title}
                                </h2>
                ...
                <div
                    ref={bodyRef}
                    className="blog-modal-scroll flex-1 overflow-y-auto px-5 sm:px-8 py-6"
                >
                    <AnimatePresence
                        mode="wait"
                        custom={navDir}
        ...
        >
            <div className="absolute inset-0">
                ...
                <div
                    ...
                    style={{
                        background:
                            'linear-gradient(to top, rgba(0,0,0,0.97) 0%, rgba(0,0,0,0.5) 50%, rgba(0,0,0,0.1) 100%)'
                    }}
                />
            </div>
            ...
            <div className="absolute top-5 left-5 flex items-center gap-2">
                ...
                <span
                    ...
                    style={{
                        background: 'rgba(231,23,99,0.9)',
                        boxShadow: '0 0 15px rgba(231,23,99,0.5)'
                    }}
                >
                    Featured
                </span>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-white mb-3 leading-tight group-hover:text-primary transition-colors">
                    {post.title}
                </h3>

                <p className="text-white/50 text-sm mb-4 line-clamp-2 max-w-lg">
                    {post.excerpt}
                </p>
    ...
    return (
        <motion.article
            ...
            onMouseEnter={(e) => {
                e.currentTarget.style.borderColor =
                    'rgba(231,23,99,0.35)';
                e.currentTarget.style.boxShadow =
                    '0 20px 50px rgba(0,0,0,0.5), 0 0 30px rgba(231,23,99,0.08)';
            }}
            onMouseLeave={(e) => {
                e.currentTarget.style.borderColor =
                    'rgba(255,255,255,0.07)';
        ...
        >
            ...
            <div className="p-5 flex flex-col flex-1">
                ...
                <h3 className="font-black text-base text-white mb-2 line-clamp-2 group-hover:text-primary transition-colors leading-snug">
                    {post.title}
                </h3>
            ...
            >
                ...
                <div className="absolute inset-0 pointer-events-none">
                    <motion.div
                        ...
                        style={{
                            background:
                                'radial-gradient(ellipse 80% 50% at 50% 20%, rgba(231,23,99,0.05) 0%, transparent 70%)'
                        }}
                        animate={{
                            opacity: [0.4, 0.9, 0.4]
                        }}
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-white/40 max-w-lg mx-auto text-sm leading-relaxed">
                            Science-backed tips from the RECODE™
                            system — recovery, nutrition, training
                            &amp; mindset.
                        </p>
                    </motion.div>
