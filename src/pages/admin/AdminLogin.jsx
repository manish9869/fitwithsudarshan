...
export default function AdminLogin() {
    ...
    /**
     * Important:
     * Public pages hide the native cursor using body:not(.admin-page).
     * AdminLogin is outside AdminLayout, so we must add admin-page here too.
     */
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center px-4 cursor-default">
            {/* Extra safety cursor override only for this page */}
            <style>
                {`
                    body.admin-page,
                    body.admin-page * {
                ...
                >
                    ...
                    <form onSubmit={handleLogin} className="px-8 py-8 space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onFocus={(e) => {
                                    ...
                                    e.currentTarget.style.boxShadow = '0 0 0 3px rgba(231,23,99,0.08)';
                                }}
                                onBlur={(e) => {
                        ...
                        <motion.button
                            ...
                            className="w-full py-3.5 rounded-xl font-bold text-sm text-white mt-2 flex items-center justify-center gap-2 disabled:opacity-60 cursor-pointer disabled:cursor-not-allowed"
                            style={{
                                background: '#e71763',
                                boxShadow: '0 0 25px rgba(231,23,99,0.35)',
                            }}
                        >
                            {loading ? (
                                <>
